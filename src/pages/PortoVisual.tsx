...
import CreativeCategoryIndex from "../components/CreativeCategoryIndex";
import FooterContact from "../components/FooterContact";

gsap.registerPlugin(ScrollTrigger);

export default function PortoVisual() {
  ...
  return <main className="relative z-10 pt-28 md:pt-32">
    <section ref={ref} data-text-motion-ignore className="px-5 pb-14 md:px-12 md:pb-20">
      <p data-page-text className="mono-label mb-4">Creative Portfolio</p>
      <h1 data-page-text className="text-hero break-words">VISUAL<br/>CREATIVE</h1>
      <p data-page-text className="mt-8 max-w-2xl text-lg text-base-300">Design archives, layouts, GMV, brand visuals, interface mood, and creative systems made for clarity, rhythm, and attention.</p>
    </section>
